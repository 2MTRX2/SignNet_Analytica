...
@pytest.fixture
def csv_strategy(mock_representation):
    return CsvStrategy(representation=mock_representation)

# =====================================================================
# 2. READING
# =====================================================================

def test_read_raw_loads_and_caches_dataframe(csv_strategy):
    # ARRANGE
...
def test_load_delegates_to_representation_handler(csv_strategy, mock_representation):
    # ARRANGE
    fake_file = "dummy_network.xlsx"
...
def test_is_subclass_of_data_loading_strategy(csv_strategy):
    from signnet.io.data_loading.DataLoadingStrategy import DataLoadingStrategy
    assert isinstance(csv_strategy, DataLoadingStrategy)
